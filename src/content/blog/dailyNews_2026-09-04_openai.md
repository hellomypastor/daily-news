...
ChatGPT Release Notes 最新可见条目仍为 9 月 1 日，未发现 Astra 对 ChatGPT 各端具体开关时间；官方仅称未来数日陆续开放。模型文档页面没有单独显示更新时间，本页以发布原文的 9 月 3 日为事件日期，不编造时分。
