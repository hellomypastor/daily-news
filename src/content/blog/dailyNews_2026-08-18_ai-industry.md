...
updatedAt: "2026-08-18T16:28:10+08:00"
...
主窗口：2026-08-17 16:28 至 2026-08-18 16:28（Asia/Shanghai）；近两日补充窗口为 2026-08-16 16:28 至 2026-08-17 16:28，近三日补充窗口为 2026-08-15 16:28 至 2026-08-16 16:28。本轮新增可核实信号主要来自 OpenAI Codex/Agents SDK 主分支、LangChain/Deep Agents 发布，以及 Microsoft Agent Framework、Google DeepMind Simply 和 Claude Agent SDK 的仓库维护；主分支提交均未冒充正式产品发布。
...
除表内项目外，Google DeepMind、Microsoft 与 LangChain 同窗口的大量候选主要是依赖、文档、样例或常规修复；Meta、xAI、Mistral、Cohere、国内主要厂商、NVIDIA、Hugging Face 与 LlamaIndex 官方入口未核实到同窗口内的新技术发布。
...
**一句话总结：本轮产业增量集中在 OpenAI Codex 的安全与权限主分支改动、Deep Agents CLI 的正式发布及多个 Agent 框架的工程维护，需继续区分“已合入提交”和“已发布产品”。**
...
- 初始候选：106；保留来源：35；二次补搜：否（最终来源不为 0）。
